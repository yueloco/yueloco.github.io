...
| ファイル名 | 表情/ポーズ |
|---|---|
| `misaki_normal.png` | 通常（憔悴ぎみの女性） |

### 木村 真一（第2話 証人） — 5ポーズ
| ファイル名 | 表情/ポーズ |
|---|---|
| `kimura_normal.png` | 通常（落ち着いた態度） |
| `kimura_nervous.png` | 焦り・動揺 |
| `kimura_surprised.png` | 驚き |
| `kimura_lying.png` | 嘘をついている（虚勢） |
| `kimura_breakdown.png` | 崩壊（自白の瞬間） |
...
| ファイル名 | 内容 | 推奨サイズ |
|---|---|---|
| `knife.png` | 凶器の包丁（証拠袋に入った） | 140×140 |
| `alibi_card.png` | 社員証ログ（カードリーダー記録） | 140×140 |
| `mansion_cam.png` | マンション防犯映像のスクショ | 140×140 |
| `diary.png` | 高橋の日記（手書きノート） | 140×140 |
